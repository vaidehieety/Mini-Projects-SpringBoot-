...
public class TuneInApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println("Your Playlist with reference Id: " + user.toString().substring(28, user.toString().length())
				+ " is Ready!!");
		for (Song song : user.getPlaylist().getPlaylistSongs()) {
			System.out.println("Song name: " + song.getSongName() + "\t Reference Id: "
					+ song.toString().substring(28, song.toString().length()));
		}
